...
import com.teenstian.universaldemo.googleprogressbar.FoldingCirclesDrawable;
import com.teenstian.universaldemo.swipelistview.library.SwipeListViewListener;
import com.teenstian.universaldemo.systembartintmanager.SystemBarTintManager;
...
//		tintManager.setNavigationBarTintEnabled(true);
        ...
        //edit the progress shape in the 'XML'
        progressBar.setIndeterminateDrawable(new FoldingCirclesDrawable());
...
////          }  
//            
//            map.put("icon", pi.applicationInfo.loadIcon(pm));//图锟斤拷  
//            map.put("appName", pi.applicationInfo.loadLabel(pm));//应锟矫筹拷锟斤拷锟斤拷锟�  
//            map.put("packageName", pi.applicationInfo.packageName);//应锟矫筹拷锟斤拷锟斤拷锟�
//            
//            items.add(map);  
//        }  
//        
...
//	      			appMap.put("appVersion", "  V" + appVersion);
		...
		protected void onPostExecute(List<Map<String, Object>> result) {
	        ...
	        adapter = new MyAdapter(PackageInfoActivity.this, result, R.layout.packgeinfo_list_item,   
	                new String[]{"icon", "appName", "packageName"},  
	                new int[]{R.id.icon, R.id.appName, R.id.packageName}); 
